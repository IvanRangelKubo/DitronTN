...
{% if not cart_page %}
  ...
  <div class="js-visible-on-cart-filled h5 font-big row mb-2" {% if cart.items_count == 0 %}style="display:none;"{% endif %} data-store="cart-subtotal">
...
{% if cart_page %}
  ...
  <div id="cart-sticky-summary" class="position-sticky-md cart-page-totals">
    ...
    <div class="js-visible-on-cart-filled h5 row no-gutters font-big mb-2" {% if cart.items_count == 0 %}style="display:none;"{% endif %} data-store="cart-subtotal">
    ...
    <div class="js-visible-on-cart-filled" {% if cart.items_count == 0 %}style="display:none;"{% endif %}>
      ...
      {% if cart_page %}
        ...
        {% if cart.checkout_enabled %}
          <input id="go-to-checkout" class="btnagregar w-button" type="submit" name="go_to_checkout" value="{{ 'Pagar pedido' | translate }}"/>
        {% else %}
